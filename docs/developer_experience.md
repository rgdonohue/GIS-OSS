...
- **Consent helpers**: SDK will bundle small utilities for passing consent context (tribal role, elder approval token) and for redacting exports when sharing outside the firewall.
